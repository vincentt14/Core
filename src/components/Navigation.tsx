    ...
    <div className="my-20">
      ...
      <div className="flex gap-4">
        <div className="md:grid md:grid-rows-3 md:divide-y divide-borderColor items-center justify-center border border-borderColor w-16 rounded-md md:shadow-xl bg-tertiary">
          <div
            className={`w-16 h-16 cursor-pointer hover:bg-blue-500 hover:rounded-md hover:text-black flex items-center justify-center ${active ? "bg-white text-black rounded-md border-4 border-blue-500" : ""}`}
