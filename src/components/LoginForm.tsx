...
const LoginForm = () => {
  return (
    <form className="bg-transparent">
      ...
      <button className="w-full bg-black hover:bg-white text-white hover:text-black border-black hover:tracking-[5px] border-2 py-2 px-4 my-3 ease-out duration-300 focus:outline-none focus:ring focus:ring-blue-500 selection:bg-blue-500 selection:text-blue-100">
