  ...
  return (
    <form className="bg-transparent">
      <div className="flex items-center justify-center">
        ...
        <input className="w-full border-2 border-[#030723] my-3 h-9 bayangan_field focus:outline-none focus:ring focus:ring-blue-500 p-2" type="text" placeholder="Name" />
      </div>
      <div className="flex items-center justify-center">
        <i className="mr-3 text-xl">
          <FiAtSign />
      ...
      <div className="flex items-center justify-center">
        ...
        <input className="w-full border-2 border-[#030723] my-3 h-9 bayangan_field focus:outline-none focus:ring focus:ring-blue-500 p-2" type="password" placeholder="Confirm Password" />
      </div>
